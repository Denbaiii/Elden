...
from .serializer import RegistrationSerializer, ActivationSerializer, UserSerializer, RegistrationPhoneSerializer, ConfirmPasswordSerializer, ResetPasswordSerializer
